import{_ as e,M as p,p as o,q as i,Q as l,R as n,t as s,N as r,a1 as a}from"./framework-736064bf.js";const c={},u=a(`<h1 id="前端工程化一" tabindex="-1"><a class="header-anchor" href="#前端工程化一" aria-hidden="true">#</a> 前端工程化一</h1><h2 id="配置eslint" tabindex="-1"><a class="header-anchor" href="#配置eslint" aria-hidden="true">#</a> 配置eslint</h2><ul><li>安装eslint或者其他相关包（使用框架react,vue等）或者</li><li>使用npx eslint --init自动生成</li></ul><p>创建一个.eslintrc.js文件</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
