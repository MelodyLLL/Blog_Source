import{_ as n,p as s,q as a,a1 as p}from"./framework-736064bf.js";const e={},t=p(`<h1 id="typescript常量定义" tabindex="-1"><a class="header-anchor" href="#typescript常量定义" aria-hidden="true">#</a> typescript常量定义</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">type</span> <span class="token class-name">Type</span> <span class="token operator">=</span><span class="token string">&#39;type&#39;</span>
